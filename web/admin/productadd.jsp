			...
			<form class="layui-form col-lg-4" id="supplierform" method="post" action="<%=path %>/admin/productAdd.do" onsubmit="return supplieradd()">
				...
				<div class="layui-form-item">
					...
					<div class="layui-input-block">  
					  	<input type="text" name="productname" id="productname" required oninvalid="setCustomValidity('菜品名称不能为空')" oninput="setCustomValidity('');"  style="width: 300px;"  autocomplete="off"  class="layui-input" placeholder="菜品名称" >
					</div>
				</div>
				...
				<div class="layui-form-item">
					...
					<div class="layui-input-block">  
					  	<input type="text" name="price" id="price" required oninvalid="setCustomValidity('菜品单价不能为空或价格输入有误')" oninput="setCustomValidity('');"  pattern="(0|[1-9][0-9]{0,9})(\.[0-9]{1,2})?" style="width: 300px;"  autocomplete="off"  class="layui-input" placeholder="菜品单价" >
					</div>
				</div>
				...
				<div class="layui-form-item">
					...
					<div class="layui-input-block">  
					  	<input type="text" name="author" id="author" required oninvalid="setCustomValidity('产地不能为空')" oninput="setCustomValidity('');"  style="width: 300px;"  autocomplete="off"  class="layui-input" placeholder="产地" >
					</div>
				</div>
				...
				<div class="layui-form-item">
					...
					<div class="layui-input-block">  
					  	<input type="text" name="press" id="press" required oninvalid="setCustomValidity('品级不能为空')" oninput="setCustomValidity('');"  style="width: 300px;"  autocomplete="off"  class="layui-input" placeholder="品级" >
					</div>
				</div>
				...
				<div class="layui-form-item">
					...
					<div class="layui-input-block">  
					  	<textarea name="content" placeholder="请输入菜品介绍" required class="layui-textarea" oninvalid="setCustomValidity('菜品介绍不能为空')" oninput="setCustomValidity('');" ></textarea>
					</div>
				</div>
