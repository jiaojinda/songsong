			...
			<a class="layui-btn layui-btn-danger" href="javascript:void(0)" onclick="deleteAll()">批量删除</a>
                ...
                <div class="layui-form news_list" >
                    ...
                    <td align="center" style="font-weight: bold;font-family:楷体;font-weight: bold; color:blue" colspan="8">
                                                                 共${total}条记录&nbsp;&nbsp;&nbsp;&nbsp;
                        <a href="userList.do?index=1" style="font-family:楷体;">首页</a>&nbsp;&nbsp;
                        
                        <c:choose>
                        <c:when test="${index >1}">
                        <a href="userList.do?index=${index-1}" style="font-family:楷体;">上一页</a>
                        </c:when>
                        <c:otherwise>
                        ...
                        <a href="userList.do?index=${index+1}" style="font-family:楷体;">下一页</a>
                        </c:when>
                        <c:otherwise>
                        ...
                        &nbsp;&nbsp;
                        <a href="userList.do?index=${pages}" style="font-family:楷体;">末页</a>
                    </td>
                  </tr>
					</tbody>
					</table>
