        ...
        <div class="container_12">
			...
			<div id="wrapper_tab" class="tab1">
			    ...
			    <div class="tab1 tab_body">
					<table>
				      <tr class="bg">
					   <th>订单编号</th><th>总价(￥)</th><th>创建时间</th><th>备注信息</th><th style="width: 100px;">操作</th>
				      </tr>
				     <c:forEach items="${fklist}" var="fkorder">
					  <tr>
						  ...
						  <td>
						 <font style="font-weight: bold;">备注:</font>&nbsp;&nbsp;${fkorder.addr}&nbsp;&nbsp;&nbsp;&nbsp;${fkorder.name}&nbsp;&nbsp;&nbsp;&nbsp;${fkorder.tel}
						  </td>
			    ...
			    <div class="tab2 tab_body">
				     ...
				     <c:forEach items="${shlist}" var="shorder">
					  <tr>
						  ...
						  <td>
						 <font style="font-weight: bold;">备注:</font>&nbsp;&nbsp;${shorder.addr}&nbsp;&nbsp;&nbsp;&nbsp;${shorder.name}&nbsp;&nbsp;&nbsp;&nbsp;${fkorder.tel}
						  </td>
				...
				<table>
						<tr class="bg">
					   <th>订单编号</th><th>总价(￥)</th><th>创建时间</th><th>备注信息</th>
				      </tr>
				     <c:forEach items="${wclist}" var="wcorder">
					  <tr>
						  ...
						  <td>
						 <font style="font-weight: bold;">备注:</font>&nbsp;&nbsp;${wcorder.addr}&nbsp;&nbsp;&nbsp;&nbsp;${wcorder.name}&nbsp;&nbsp;&nbsp;&nbsp;${wcorder.tel}
						  </td>
					  </tr>
					  </c:forEach>
					</table>
...
function orderpay(id,total){
	location.replace('payOrder.do?id='+id);
