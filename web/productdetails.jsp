...
<body>
    ...
    <div class="breadcrumbs">
        <div class="container_12">
            <div class="grid_12">
                 <a href="index.do">首页</a><span></span><a href="productDetails.do?id=${product.id}">菜品详情</a>
            </div><!-- .grid_12 -->
        </div><!-- .container_12 -->
    </div><!-- .breadcrumbs -->
        ...
        <div class="container_12">
			...
			<div class="entry_content">
				...
				<div class="availability_sku">
					...
					菜品类别: <font style="color:#6F8921">${product.category.name}</font>
				    </div>
				    <div class="availability">
					产地: <font style="color:#6F8921">${product.author}</font>
				    </div>
				    <div class="availability">
					品级: <font style="color:#6F8921">${product.press}</font>
				    </div>
				     <div class="availability" style="font-weight: bold;">
					投票: ${product.vote}<a href="javascript:void(0)" onclick="toupiao('${product.id}')"><img alt="" src="/songsong/images/toupiao.jpg" style="width: 30px;height: 30px;"></a>
				    </div>
			...
			<div id="wrapper_tab" class="tab1">
			    <a href="#" class="tab1 tab_link">菜品描述</a>
