        ...
        <div class="container_12">
            ...
            <div class="grid_9" style="border:0px solid red;width: 98%">
                <div class="top_header">
                    <div class="welcome">
                         <a href="index.do" style="font-size: 24px;text-decoration:none;">怂怂的小屋</a>.
                    </div><!-- .welcome -->
				<c:if test="${sessionScope.sessionmember ne '' && sessionScope.sessionmember!=null}">
                    <ul id="cart_nav">
                        <li>
                            ...
                            <ul class="cart_cont">
                                ...
                                <li>
                                    <a  class="prev_cart"><div class="cart_vert"><img src="<%=path %>/upload/${cart.product.filename}" alt="Product 1" title=""></div></a>
                                    <div class="cont_cart" >
                    ...
                    <form class="search" action="searchProductname.do" method="post">
                        ...
                        <input type="text" name="productname" class="search_form" value="${productname}" placeholder="搜索菜品...">
                    </form><!-- .search -->
                </div><!-- .top_header -->
                ...
                <nav class="primary">
                    <ul>
                        ...
                        <li><a href="popularityProduct.do">最具人气菜品</a></li>
